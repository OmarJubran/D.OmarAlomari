      ...
      <div className="relative max-w-7xl mx-auto px-6 pt-32 pb-20 grid lg:grid-cols-2 gap-12 items-center">
        <div className="animate-fade-up">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 mb-6">
            ...
            <span className="text-sm text-brand-50 font-medium">Advanced Dental Care</span>
          </div>
          ...
          <p className="text-lg text-brand-50/80 leading-relaxed mb-8 max-w-xl">
            At Dr. Omar Alomari Dental Clinic, we combine years of expertise with
            cutting-edge technology to give you a healthy, confident smile that lasts a lifetime.
          </p>
          ...
          <div className="flex flex-wrap gap-6">
            {[
              ...
              { icon: ShieldCheck, label: 'Certified Specialist' },
        ...
        <div className="relative animate-fade-up" style={{ animationDelay: '0.2s' }}>
          <div className="relative">
            ...
            />
            <div className="absolute -bottom-6 -right-6 bg-white rounded-2xl shadow-xl p-5 flex items-center gap-3 animate-float">
            ...
            <div className="absolute -top-6 -left-6 bg-white rounded-2xl shadow-xl p-5 flex items-center gap-3 animate-float" style={{ animationDelay: '1s' }}>
